...
const Education = () => {
    const educationData = [
        {
            id: 1,
            degreee: 'Bachelor of Computer Science',
            instituion: "State Univeristy of Technology",
            duration: "2020 - 2022",
        ...
        },
        {
            ...
            instituion: "Tech Institute of Design",
            duration: "2023 - 2026",
            details: " Lorem ipsum dolor sit amet consectetur, adipisicing elit"
        }
    ]
    return (
        <section className='text-white py-20 overflow-hidden' id="eduaction">
                    ...
                    <div className='w-full lg:w-5/12 flex justify-center lg:justify-start' data-aos='fade-right'>
                        <div className='relative'>
                            ...
                            <div className='relative z-10 bg-[#111a3e] rounded-2xl overflow-hidden border border-[#1f1641]'>
                                <img className='w-64 h-64 md:w-96 md:h-120 object-cover transform transition-transform duration-500 hover:scale-110' src={educ} alt="Education" />
                            </div>
