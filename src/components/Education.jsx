...
const Education = () => {
  const educationData = [
    {
      id: 1,
      degreee: "Bachelor of Information Technology",
      instituion: "GKM College of Engineering and Technology",
      duration: "2015 - 2019",
      cgpa: 6.9 / 10,
      details:
        "CGPA : 6.9/10 | Core Focus on web Programming, web designing and cyber security  ",
    },
  ];
  return (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">{edu.instituion}</p>
                    </div>
                  </div>
